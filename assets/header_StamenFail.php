	  ...
	  // Google Maps Initialization
		'<script type="text/javascript">' .
			'function googMapsInitialize() {' .
				  // Stamen maps layer type: replace "toner" here with "terrain" or "watercolor"
				  //'var stamenMapLayer = "toner";' .
				  'var mapOptions = {' .
						'zoom: 12,' .
						'center: new google.maps.LatLng(37.7, -122.4),' .
						'mapTypeId: google.maps.MapTypeId.ROADMAP,' .
						/*'mapTypeId: stamenMapLayer,' .
						'mapTypeControlOptions: {' .
							'mapTypeIds: [stamenMapLayer]' .
						'}' .
						*/
				  '}' .
				  'var map = new google.maps.Map(document.getElementById("map-canvas"), mapOptions);' .
				  //'map.mapTypes.set(stamenMapLayer, new google.maps.StamenMapType(stamenMapLayer));' .
			'}' .
			...
			'function loadGoogMapsScript() {' .
				'var script = document.createElement("script");' .
			  	...
			  	'key=AIzaSyCYOQTdZ4jIU3Eu84shj0e3cNMDb4bVIco' .
			  	'&sensor=false&" + "callback=googMapsInitialize";' .
			  	'document.body.appendChild(script);
			}' .
			
			/*
			// loads Stamen maps Javascript
			'function loadStamenMapsScript() {
			  var script = document.createElement("script");
			  script.type = "text/javascript";
			  script.src = "http://maps.stamen.com/js/tile.stamen.js?v1.2.3";' .
			  'document.body.appendChild(script);
			}
			
			window.onload = loadStamenMapsScript;' .
			*/
