...
if (isset($_POST['pinid'])){
	...
	$pinrow = mysql_fetch_row(queryMysql("SELECT * FROM pins WHERE pin_id='$unique_pin_id'"));
	$unique_place_id = $pinrow[1];
	$description = $pinrow[3];
	$query = "SELECT * FROM places WHERE place_id='$unique_place_id'";
	$placerow = mysql_fetch_row(queryMysql($query));
...
<input type='text' name='placetitle' value='$placetitle' placeholder='name this place' class="input-xlarge"><br />
<input type='text' name='street' value='$street' placeholder='street' class="input-xlarge"><br />
<input type='text' name='city' value='$city' placeholder='city' class="input-xlarge"><br />
<input type='text' name='country' value='$country' placeholder='country' class="input-xlarge"><br />
